 ...
 * Guides users through HiLab setup: preflight checks, environment config, optional packages, and kit installation
 */
...
export async function setupCommand(options: SetupOptions): Promise<void> {
	clack.intro("HiLab Setup Wizard");
	...
	// Success message
	clack.outro("Setup complete! HiLab is ready to use.");
