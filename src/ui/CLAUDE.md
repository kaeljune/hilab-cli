...
**The Dashboard is HiLab's visual home.** Where the CLI is fast and focused, the Dashboard is rich and educational. It's where users:
...
|------|---------|----------------|
| **Newcomer** | "What is HiLab?" | Onboarding → Kit comparison → Guided install |
