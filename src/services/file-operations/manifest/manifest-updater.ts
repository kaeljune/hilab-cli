 ...
 * @param kitType - Kit type identifier (coding, marketing)
...
export async function writeManifest(
	...
	const kit: KitType = kitType || (/\bmarketing\b/i.test(kitName) ? "marketing" : "coding");
	...
	try {
		...
		// - If installing "marketing" and "coding" already exists → otherKitsExist = true
		// - If re-installing "coding" and only "coding" exists → otherKitsExist = false
