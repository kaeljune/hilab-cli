...
export const NewCommandOptionsSchema = z
	.object({
		...
		kit: z.string().optional(), // Accepts "all", "coding,marketing", or single kit - validated in selection-handler
...
export const UninstallCommandOptionsSchema = z
	.object({
		...
		kit: KitType.optional(), // Kit-scoped uninstall (coding, marketing)
	})
	.merge(GlobalOutputOptionsSchema);
