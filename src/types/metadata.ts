...
export type FileOwnership = "hi" | "user" | "hi-modified";
...
export const LegacyMetadataSchema = z.object({
	...
	installedAt: z.string().optional(),
	scope: z.enum(["local", "global"]).optional(),
	// Files/directories installed by HiLab (relative paths)
...
export interface HiLabSetupInfo {
	path: string;
	metadata: HiLabMetadata | null;
	components: ComponentCounts;
}

export interface HiLabSetup {
	global: HiLabSetupInfo;
	project: HiLabSetupInfo;
}
