 ...
 * @param kitType - Optional kit type to check access for. Defaults to 'coding'.
 */
export async function checkRepositoryAccess(kitType: KitType = "coding"): Promise<CheckResult> {
