...
export class ReleasesApi {
	 ...
	 *
	 * @see https://github.com/kaeljune/hilab-cli/issues/256
	 */
		...
		return withAuthRetry(async () => {
			try {
				...
				return handleHttpError(error, {
					...
					verboseFlag: "hi versions --verbose",
				});
			}
		});
	}
