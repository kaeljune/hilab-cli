 ...
 *
 * Manages tracking of CK-installed settings in .hi.json to respect user deletions.
...
export class InstalledSettingsTracker {
	...
	constructor(projectDir: string, isGlobal: boolean, kitName = "coding") {
	...
	/**
	 * Get path to .hi.json based on scope
	 */
	...
	/**
	 * Load installed settings from .hi.json
	 */
	...
	/**
	 * Save installed settings to .hi.json
	 */
