...
/**
 * CLI entry point for npm-installed HiLab CLI.
...
const runWithNode = async () => {
	...
	if (!existsSync(distPath)) {
		throw new Error(
			"Compiled distribution not found. Reinstall HiLab CLI or report a packaging issue.",
		);
	}
...
const main = async () => {
	...
	try {
		...
		console.error("Please report this issue at: https://github.com/kaeljune/hilab-cli/issues");
		process.exit(1);
	}
};
